        ...
        <div className="space-y-6">
          ...
          <section className="bg-card border border-default rounded-2xl shadow-xl p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link to={`code-editor/view-project`} className="text-xs font-semibold btn-gradient text-white px-4 py-2 rounded-xl shadow-md hover:opacity-90 transition">Open in Code Editor</Link>
            </div>
