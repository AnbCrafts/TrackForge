...
const PageHeader = ({ want = true }) => {
  ...
  return (
    <div className="p-3 flex flex-wrap items-center justify-between bg-secondary border-b border-default backdrop-blur-xl gap-4">
          ...
          {[
            ...
            <div
              ...
              className="flex items-center gap-2 text-sm px-4 py-1.5
                         ...
                         hover:border-neon
                         hover:shadow-[0_0_12px_var(--glow-shadow)]
                         transition-all"
            >
