...
# 🔑 **Database Seed Test Credentials**

For visitors or testers looking to explore the live application or test different role-based views, you can log in using any of the following accounts:
